...
// Snipers as 2nd group (20 max) - no reinforcements of these.
...
_staticGuns =	[
					[
						...
						[21785.7,21032.6,42.482],
						[21747,21004.4,40.179],
						[21888.4,21034.8,33.594],
						[22066.1,21114.5,41.857],
						[22082.5,21097.8,42.002]
					],
					_group,
					"assault",
					_difficulty,
...
_baseObjs =	[
				"gogs_submarine_buidlings"
			] call DMS_fnc_ImportFromM3E_3DEN_Static;
			
// Define the classnames and locations where the crates can spawn (at least 2, since we're spawning 2 crates)
_crateClasses_and_Positions =	[
									[[21977.5,21027.8,0.10],"I_CargoNet_01_ammo_F"],
									[[21967,21033.6,0.10],"I_CargoNet_01_ammo_F"],
									[[21874.6,20915.2,0.10],"I_CargoNet_01_ammo_F"],
									[[21728.4,20882,0.10],"I_CargoNet_01_ammo_F"],
									[[21784.4,21052,0.10],"I_CargoNet_01_ammo_F"],
									[[22070.9,21048.2,0.10],"I_CargoNet_01_ammo_F"]
								];
...
[
	...
	[
		...
		[
		        ...
		        "B_T_VTOL_01_infantry_olive_F"      // STRING (OPTIONAL): The classname of the heli to spawn.
		]
	],
